  ...
  <div class="flex items-center gap-1.5">
    ...
    <div class="relative min-w-0 flex-1">
      ...
      <input
        ...
        class="h-9 w-full rounded-md bg-[color-mix(in_oklch,var(--sidebar-accent)_40%,var(--background))] pl-8 pr-8 text-xs text-foreground placeholder:text-muted-foreground/70 transition-colors focus:outline-none focus-visible:ring-1 focus-visible:ring-primary/50 [&::-webkit-search-cancel-button]:appearance-none"
      >
      <button
        v-if="search"
        type="button"
