import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, inject, toRef, isRef, ref, customRef, getCurrentInstance, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, defineAsyncComponent, computed, unref, shallowReactive, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, withCtx, nextTick, isReadonly, toValue, useSSRContext, isShallow, isReactive, toRaw } from 'vue';
import { k as klona, c as createError$1, p as parseURL, e as encodePath, l as decodePath, m as hasProtocol, n as isScriptProtocol, o as joinURL, w as withQuery, q as getRequestURL, r as getRequestHeader, s as isEqual, t as sanitizeStatusCode, v as setCookie, x as getCookie, y as deleteCookie, z as getContext, A as defuFn, $ as $fetch$1, B as defu, C as executeAsync, D as hash, E as getResponseHeaders, F as getRequestHeaders, G as splitCookiesString, H as setResponseHeaders } from '../nitro/nitro.mjs';
...
const _routes = [
  ...
  },
  {
    name: "inventory",
    path: "/inventory",
    component: () => import('./inventory-C2wjSqmb.mjs')
  },
  {
    name: "market",
    path: "/market",
    component: () => import('./market-CZ8KjEk8.mjs')
  },
  {
    name: "sell",
    path: "/sell",
  ...
  },
  {
    name: "trade-lab",
    path: "/trade-lab",
    component: () => import('./trade-lab-DSGO8COv.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-C65hfvXZ.mjs')
  }
];
...
const namedMiddleware = {
  "sanctum:auth": () => import('./sanctum.auth-BzKuPuA-.mjs'),
  "sanctum:guest": () => import('./sanctum.guest-1FR999Pn.mjs')
};
...
const createUseFetch = defineKeyedFunctionFactory({
  name: "createUseFetch",
  factory(options = {}) {
    function useFetch2(request2, arg1, arg2) {
...
async function setRequestOrigin(_app, ctx, logger) {
  const config = useSanctumConfig();
...
async function resolveTokenStorage(nuxtApp, logger) {
  ...
  const defaultStorage = await import('./cookieTokenStorage-CtQVKVBk.mjs');
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CYd8uOKa.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DnNyZ6fZ.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DAblTrr-.mjs'));
...
export { IDENTITY_LOADED_KEY as I, _export_sfc as _, useCookie as a, useNuxtApp as b, useRoute as c, useSanctumConfig as d, entry_default as default, useSanctumAppConfig as e, useSanctumLogger as f, defineNuxtRouteMiddleware as g, createError as h, useRouter as i, encodeRoutePath as j, useRuntimeConfig as k, nuxtLinkDefaults as l, useSanctumUser as m, navigateTo as n, useState as o, resolveRouteObject as r, useRequestURL as u };
